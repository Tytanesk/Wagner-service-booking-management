-- CORRECTED DATABASE FIX - Run this entire script in Supabase SQL Editor
...
ALTER SEQUENCE IF EXISTS cached_bookings_id_seq RESTART WITH 1001;
ALTER SEQUENCE IF EXISTS user_property_access_id_seq RESTART WITH 1;
...
-- -- =====================================================
-- INSERT INTO cached_bookings (id, property_id, first_name, last_name, arrival_date, departure_date, total_nights, num_adult, num_child, price, commission, status, api_source, phone, email, data, updated_at) VALUES
-- (1001, 292355, 'John', 'Smith', '2025-12-31', '2026-01-05', 5, 2, 1, 450.00, 22.50, 'confirmed', 'Airbnb', '+49 89 111222', 'john.smith@email.de', '{}', NOW()),
-- (1002, 298151, 'Maria', 'Garcia', '2025-12-28', '2026-01-02', 5, 2, 0, 380.00, 26.60, 'confirmed', 'Booking.com', '+49 89 333444', 'maria.garcia@email.com', '{}', NOW()),
-- (1003, 298245, 'David', 'Johnson', '2026-01-15', '2026-01-20', 5, 1, 0, 320.00, 22.40, 'confirmed', 'Direct', '+49 30 777888', 'david.johnson@email.de', '{}', NOW()),
-- (1004, 300461, 'Anna', 'Mueller', '2026-01-10', '2026-01-17', 7, 4, 2, 560.00, 39.20, 'confirmed', 'Airbnb', '+49 171 555666', 'anna.mueller@email.de', '{}', NOW()),
-- (1005, 292355, 'Peter', 'Schmidt', '2026-02-14', '2026-02-21', 7, 2, 0, 630.00, 31.50, 'confirmed', 'Booking.com', '+49 30 999888', 'peter.schmidt@email.de', '{}', NOW()),
-- (1006, 298151, 'Lisa', 'Weber', '2026-01-25', '2026-01-30', 5, 3, 1, 400.00, 28.00, 'confirmed', 'Direct', '+49 89 444555', 'lisa.weber@email.de', '{}', NOW());
